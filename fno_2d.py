...
class SpectralConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        out_ft[:, :, :self.modes1, :self.modes2] = compl_mul2d(x_ft_real[:, :, :self.modes1, :self.modes2], self.weights1)
        out_ft[:, :, -self.modes1:, :self.modes2] = compl_mul2d(x_ft_real[:, :, -self.modes1:, :self.modes2], self.weights2)
        ...
        # Check shape
        print(f"Output shape: {x.shape}")  # Should match the shape of x
...
# configs
################################################################
TRAIN_PATH = './data/darcy_flow/piececonst_r421_N1024_smooth1.mat'
TEST_PATH = './data/darcy_flow/piececonst_r421_N1024_smooth2.mat'
